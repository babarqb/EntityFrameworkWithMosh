...
using EntityFrameworkWithMosh.Data;

namespace EntityFrameworkWithMosh.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20170107080324_InitialModel")]
    partial class InitialModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EntityFrameworkWithMosh.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EntityFrameworkWithMosh.Models.ApplicationUser")
                        .WithMany("Claims")
